...
$update-company --update-skills  ← refresh 17 bundled skills from ~/.codex/forge/
...
| Forge marketplace not configured | Stop and direct the user to `$install-forge`; do not copy skills into the data directory. |
