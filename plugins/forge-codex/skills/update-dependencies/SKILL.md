...
Read `.codex/forge/deploy.md` or `AGENTS.md` for the test command. If not found, try:
...
```
$security-assessment  →  $update-dependencies   (when vulnerabilities found)
$update-dependencies                             (scheduled maintenance)
```
