...
```
$review-fy     ← standalone, user-invoked at period end
```
...
```
$review-fy              ← auto-detect period from current date
$review-fy --mid        ← mid-year review (July–December)
$review-fy --full       ← full FY review (July–June)
$review-fy FY2026       ← specific FY (July 2025 – June 2026)
$review-fy --from 2025-07-01 --to 2026-06-30  ← custom period
```
...
Read from `~/.codex/forge/companies/[active_company]/config.md`:
...
```
~/.codex/forge/companies/[active_company]/reviews/FY2026/
  manager-summary.md
...
- `~/.codex/forge/companies/[active_company]/registry.md` — ideas, projects, systems
- `~/.codex/forge/companies/[active_company]/ideas/active/` and `archive/`
- `~/.codex/forge/companies/[active_company]/incidents/`
- `~/.codex/forge/companies/[active_company]/reviews/` — prior FY reviews for year-over-year
- `~/.codex/forge/companies/[active_company]$pir/` — PIR outcome assessments per project and PI
- `~/.codex/forge/companies/[active_company]/retrospectives/` — sprint retrospective summaries
...
- `~/.codex/forge/pi/[pi]/plan.md` — PI plans
...
- Dependency vulnerability resolution rate (from `$update-dependencies` runs)
...
1. Check `~/.codex/forge/companies/[active_company]$pir/PROJ-NNN/` for PIR records within the period.
...
Check `~/.codex/forge/companies/[active_company]/reviews/` for a prior FY review covering
...
Write both files to `~/.codex/forge/companies/[active_company]/reviews/FY2026/`.

```
✅ [review_display_name] generated — FY2026

   Manager summary:      ~/.codex/forge/companies/[active_company]/reviews/FY2026/manager-summary.md
   Team retrospective:   ~/.codex/forge/companies/[active_company]/reviews/FY2026/team-retrospective.md
