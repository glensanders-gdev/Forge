...
8. Tell the user: "Work through this checklist, then run `qa-report` to record results before `approve`."
...
- For any feature with a UI component, include the accessibility QA checklist from the `accessibility` skill. Flag it as a section in the QA plan.
