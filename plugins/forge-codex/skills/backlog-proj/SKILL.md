...
Display the Backlog section of a specific project's `kanban.md`, grouped by priority. For the global framework backlog use `backlog-list`.

## Process

1. **Build project list** — read `~/.codex/forge/priorities.md` and `~/.codex/forge/pi/[current-pi]/plan.md` to identify active projects.
...
7. Offer: "Want to add an item to this backlog? Run `add-backlog-item`."
