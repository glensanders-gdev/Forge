...
- [ ] If this is an external deliverable, run `check-style` to validate against the company style guide
...
| `$end-pi` | Stakeholder delivery summary follows the Stakeholder Summary format above |
