...
3. **Assign features** — read `~/.codex/forge/priorities.md` and active PRDs across all projects:
...
4. **Write files:**
   - `~/.codex/forge/pi/PI-N-[name]/plan.md` — full PI plan
...
1. Read `~/.codex/forge/pi/[current-pi]/plan.md`
