...
4. Read `~/.codex/forge/pi/PI-N/plan.md` PI End section for delivery summary if `$end-pi` was run.
...
`$review-fy` Phase 2 reads `~/.codex/forge/companies/[active_company]$pir/` as a data source.
