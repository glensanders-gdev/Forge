...
1. Read `AGENTS.md` (project root) — identify tech stack, key page types, any known SEO constraints or redirects already in place.
...
| Skill | Relationship |
|-------|-------------|
| `$review-diff` | Run `$review-diff` on HTML/template changes made during SEO remediation |
