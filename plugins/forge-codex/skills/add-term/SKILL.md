...
**Scope:** Company-level — terms that apply across all projects. For project-specific terms use `update-context` or update `docs/CONTEXT.md` directly during `grill-with-docs`.
...
|-----------|------------|--------|
| Acronym or abbreviation | `~/.codex/forge/knowledge/company/acronyms.md` | Short uppercase letters, e.g. "OSS", "BSS", "CAPEX" |
| Domain concept with a definition | `~/.codex/forge/knowledge/company/context.md` | A noun or phrase that describes a business concept, process, or entity |
...
Before writing:
- Scan `~/.codex/forge/knowledge/company/acronyms.md` and `context.md` for the term
- Scan `~/.codex/forge/knowledge/company/context.md` Flagged Ambiguities
...
**Acronyms:** Append to `~/.codex/forge/knowledge/company/acronyms.md` in alphabetical order.

**Context:** Append to the `## Language` section of `~/.codex/forge/knowledge/company/context.md`. If this is the first term, replace the `_No terms defined yet_` placeholder.
...
Entries marked `_Needs enrichment_` should be revisited during the next `grill-with-docs` session to add:
