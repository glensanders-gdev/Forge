...
Before starting, check if `~/.codex/forge/knowledge/publish/confluence.md` already exists.
...
On successful connection test, write `~/.codex/forge/knowledge/publish/confluence.md`:
