---
name: "incident"
description: "Manage the full lifecycle of a production incident — declare, investigate, resolve, and write a post-mortem. Coordinates $diagnose and $rollback as sub-steps. Records at ~/.codex/forge/companies/[active_company]/incidents/INC-NNN/. Drafts stakeholder communications at each stage. Use when user runs $incident, a production issue is detected, or $rollback is triggered without a prior incident."
metadata:
  category: pi-release
...
Read `incident_severity_model` from `~/.codex/forge/companies/[active_company]/config.md`.
...
`~/.codex/forge/companies/[active_company]/incidents/INC-NNN/`
...
Write `~/.codex/forge/companies/[active_company]/incidents/INC-NNN/incident.md`:
...
🔴 INC-NNN declared — [Severity] — [Description]
   ...
   Record: ~/.codex/forge/companies/[active_company]/incidents/INC-NNN/incident.md
...
✅ Post-mortem written — INC-NNN
   ...
   Record: ~/.codex/forge/companies/[active_company]/incidents/INC-NNN/postmortem.md
