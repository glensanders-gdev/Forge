...
When the Codex Security plugin is available, use its validated finding and fix workflows for technical remediation. This skill remains responsible for Forge tracking, approval gates, and evidence records.
