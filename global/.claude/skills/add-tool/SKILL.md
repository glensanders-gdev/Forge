...
```
/add-tool                          ← add to global registry (~/.claude/tools/global.md)
/add-tool --company [name]         ← add to company registry (~/.claude/companies/[name]/tools.md)
...
- `/check-tools` — reads the same **Forge Tools Registry** (`~/.claude/tools/global.md`) to verify installations
