...
2. Explore the codebase for repeated patterns, conventions, and established approaches.
3. Read `docs/adr/` — ADRs often imply coding standards worth making explicit.
4. Draft new standards and present for confirmation.
5. On confirmation, append to the "Project-Specific Patterns" section of `.claude/CODING-STANDARDS.md`.
