...
| `~/.claude/registry.md` | Project name, PROJ-NNN |
| `~/.claude/companies/[active_company]/config.md` | `token_cost_per_1k` (optional) |
...
### 1g. Cost data — `~/.claude/companies/[active_company]/config.md`
