...
- `/user:write-article` — recommends `/check-style` on completion
- `/user:write-prd` — recommends `/check-style` on completion
- `/user:onboard-knowledge` — populates `style-guide.md` that this skill reads
- `/user:qa-plan` — include a check-style step for any externally shared deliverable
