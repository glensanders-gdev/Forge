...
```
~/.claude/companies/[active_company]/pir/
  PROJ-001/
    pir-YYYY-MM-DD.md
  PI-3/
    pir-YYYY-MM-DD.md
...
For **project-level**: check `~/.claude/companies/[active_company]/pir/PROJ-NNN/` for a prior PIR.
...
1. Read `~/.claude/companies/[active_company]/registry.md` — confirm project exists.
...
4. Read incident records since go-live: `~/.claude/companies/[active_company]/incidents/`
...
For **PI-level**: also extract PI objectives from `~/.claude/pi/PI-N/plan.md`.
...
Write to `~/.claude/companies/[active_company]/pir/[PROJ-NNN or PI-N]/pir-YYYY-MM-DD.md`.
...
✅ PIR written — [PROJ-NNN / PI-N]
   ...
   File: ~/.claude/companies/[active_company]/pir/[scope]/pir-YYYY-MM-DD.md
...
| PI-N plan not found | "PI-N plan not found at ~/.claude/pi/PI-N/plan.md. Confirm the PI identifier." Stop. |
